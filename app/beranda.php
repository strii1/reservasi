...
<nav class="navbar" style="background-color:#ADD8E6">
  ...
  <div class="row">
    <div class="col col-3"> 
      <ul class="list-group">
        <a href="formulir.php" target="kembali">
          <li class="list-group-item">Formulir Reservasi</li>
        </a>
        <a href="infokursi.php" target="kembali">
          <li class="list-group-item">Tempat Duduk</li>
        </a>
        <a href="bukti.php" target="kembali">
          <li class="list-group-item">Bukti Reservasi</li>
        </a>
